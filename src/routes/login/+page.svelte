...
<svelte:head>
	<title>{data.appName} · Sign In</title>
...
>
	...
	<p class="card-footnote">Need an account? <a href="https://drogontv.co/contact-drogon-tv" target="_blank" rel="noopener noreferrer">Contact your IPTV provider</a>.</p>
</form>
</div>
